...
\*\* figure out the president thing

pols\_df = read\_csv(“pols-month.csv”) %&gt;% separate(mon, into =
c(“year”, “month”, “day”)) %&gt;% mutate(month = month.name\[month\])
%&gt;% select (-prez\_dem, prez\_gop, day)
